...
<template>
    ...
    <div class="container">
      <div
        class="items d-flex flex-column align-items-center justify-content-center mt-3"
      >
        ...
        <div
          class="questionItems mt-4 d-flex justify-content-between col-12 col-lg-6 col-xl-6 col-md-10 col-sm-12"
        >
        ...
        <div class="col-12 col-md-5 col-sm-5 col-lg-3 col-xl-3 mt-3">
          <router-link to="/chat">
            <button class="btn text-light p-3 w-100 fs-4 mt-4 bgBtn">
              Pošalji upit
            </button></router-link
          >
        </div>
